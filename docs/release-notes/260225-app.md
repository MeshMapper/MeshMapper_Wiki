...
- **Regional Flood Scoping:** Active Mode pings are now scoped to your region's flood zone. Regional Admins set a scope in the admin panel, so only repeaters in your region forward your pings. Discovery pings are unaffected. If no scope is assigned, pings flood globally as before.
